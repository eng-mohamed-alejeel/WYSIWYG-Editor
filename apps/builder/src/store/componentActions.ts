...
export const componentActions = (set: any, get: any) => ({
  addComponent: (component: ComponentNode) => set((state: any) => {
  ...
  updateComponent: (id: ComponentId, updates: Partial<ComponentNode>) => set((state: any) => {
  ...
  deleteComponent: (id: ComponentId) => set((state: any) => {
    if (!state.project) return state;
  ...
  duplicateComponent: (id: ComponentId) => set((state: any) => {
    if (!state.project) return state;
  ...
  moveComponent: (id: ComponentId, targetId: ComponentId, position: 'before' | 'after' | 'inside') => set((state: any) => {
    if (!state.project) return state;
