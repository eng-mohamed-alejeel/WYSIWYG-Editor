...
export const CollaborationSystem: React.FC<CollaborationSystemProps> = ({ isOpen, onClose }) => {
  ...
  const [users, setUsers] = useState<User[]>([
    { id: '1', name: 'John Doe', email: 'john@example.com', avatar: 'https://via.placeholder.com/32', role: 'owner', status: 'online' },
    { id: '2', name: 'Jane Smith', email: 'jane@example.com', avatar: 'https://via.placeholder.com/32', role: 'editor', status: 'online' }
  ]);
  ...
  return (
    <>
      <Panel isOpen={isOpen} onClose={onClose} position="right" size="medium" title="Collaboration" className="h-full">
