...
export const PERMISSIONS: Permission[] = [
  ...
  },
  {
    ...
    description: 'Can view all components',
    category: 'components',
    granted: true,
  },
  {
    id: 'components.add',
    name: 'Add Components',
    description: 'Can add new components',
    category: 'components',
    granted: true,
  },
  {
  ...
  {
    id: 'export.view',
    name: 'View Export Options',
    description: 'Can view export options',
    category: 'export',
    granted: true,
  },
  {
    id: 'export.execute',
    name: 'Execute Export',
    description: 'Can execute project export',
    category: 'export',
    granted: true,
  },
  {
