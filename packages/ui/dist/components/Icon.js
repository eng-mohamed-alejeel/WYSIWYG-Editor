...
export const Icon = ({ name, size = 'medium', color, clickable = false, onClick, className = '', viewBox = '0 0 24 24', path }) => {
    const getSize = () => {
    ...
    return (_jsx("svg", { className: classes, style: style, viewBox: viewBox, fill: "none", stroke: "currentColor", strokeWidth: "2", strokeLinecap: "round", strokeLinejoin: "round", onClick: onClick, children: _jsx("path", { d: iconPath }) }));
};
export default Icon;
