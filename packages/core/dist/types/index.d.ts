 ...
 */
export type StyleProperty = 'paddingTop' | 'paddingBottom' | 'paddingLeft' | 'paddingRight' | 'marginTop' | 'marginBottom' | 'marginLeft' | 'marginRight' | 'backgroundColor' | 'color' | 'fontSize' | 'fontWeight' | 'lineHeight' | 'textAlign' | 'borderRadius' | 'borderWidth' | 'borderColor' | 'borderStyle' | 'boxShadow' | 'opacity' | 'display' | 'flexDirection' | 'justifyContent' | 'alignItems' | 'gap' | 'gridTemplateColumns' | 'gridTemplateRows' | 'width' | 'height' | 'maxWidth' | 'minWidth' | 'maxHeight' | 'minHeight' | 'position' | 'top' | 'right' | 'bottom' | 'left' | 'zIndex';
/**
 * Style value type
 */
 ...
 */
export type InspectorFieldType = 'text' | 'number' | 'color' | 'select' | 'multiselect' | 'boolean' | 'image' | 'link' | 'richtext' | 'code' | 'array' | 'object' | 'style';
/**
